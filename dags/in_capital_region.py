...
@dag(
    ...
    params={
        "counties": Param(
            ['Albany', 'Schenectady', 'Rensselaer', 'Saratoga', 'Columbia', 'Montgomery', 'Washington'],
            type="array",
        )
    },
)
def dag_from_config():
    ...
    @task(outlets=[Dataset('s3://compliance-reports/new_york/capital_region/')])
    def update_dataset():
