...
@dag(
    dag_id='in_hudson_valley_and_catskills',
    start_date=datetime(2024, 11, 1),
    schedule="0 11,13,15,17 * * *",
    default_args={
    ...
    params={
        "counties": Param(
            ['Westchester', 'Rockland', 'Putnam', 'Orange', 'Dutchess', 'Ulster', 'Sullivan', 'Greene'],
            type="array",
        )
    },
)
def dag_from_config():
    ...
    @task(outlets=[Dataset('s3://compliance-reports/new_york/hudson_valley_and_catskills/')])
    def update_dataset():
