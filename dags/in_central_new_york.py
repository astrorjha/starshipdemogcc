...
@dag(
    dag_id='in_central_new_york',
    start_date=datetime(2024, 11, 1),
    schedule="0 9,11,13,15,17 * * *",
    default_args={
    ...
    params={
        "counties": Param(
            ['Onondaga', 'Oneida', 'Oswego', 'Madison', 'Cayuga', 'Herkimer'],
            type="array",
        )
    },
)
def dag_from_config():
    ...
    @task(outlets=[Dataset('s3://compliance-reports/new_york/central_new_york/')])
    def update_dataset():
